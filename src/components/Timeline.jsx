...
export const Timeline = ({ data }) => {
  ...
  // Control how far the animated line extends (0.7 = 70% of container height)
  const maxLineHeight = height * 0.9;
  const heightTransform = useTransform(scrollYProgress, [0, 1], [0, maxLineHeight]);
